...
class MerchantLogService
{
    ...
    protected function __construct()
    {
        ...
        $this->tableName = "{$this->tablePrefix}merchant_log_{$this->tableSuffix}";
        return $this;
    }
...
CREATE TABLE `{$this->tableName}` (
  ...
  `user_id` int(10) unsigned DEFAULT '0' COMMENT '码商ID',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=630 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='码商操作日志表 - {$this->tableSuffix}';
EOT;
    }
