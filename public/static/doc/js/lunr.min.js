...
!function() {
    ...
    t.Pipeline.prototype.run = function(t) {
        for (var e = [], n = t.length, i = this._stack.length, o = 0; n > o; o++) {
            for (var r = t[o], s = 0; i > s && (r = this._stack[s](r, o, t),
            void 0 !== r); s++)
                ;
            void 0 !== r && e.push(r)
        }
    ...
    t.Vector.prototype.insert = function(e, n) {
        ...
        for (var o = i, r = i.next; void 0 != r; ) {
            if (e < r.idx)
                return o.next = new t.Vector.Node(e,n,r),
                this.length++;
            o = r,
            r = r.next
        }
    ...
    t.SortedSet.prototype.intersect = function(e) {
        for (var n = new t.SortedSet, i = 0, o = 0, r = this.length, s = e.length, a = this.elements, h = e.elements; ; ) {
            if (i > r - 1 || o > s - 1)
                break;
            a[i] !== h[o] ? a[i] < h[o] ? i++ : a[i] > h[o] && o++ : (n.add(a[i]),
            i++,
            o++)
        }
        return n
    ...
    t.Index.prototype.add = function(e, n) {
        ...
        this._fields.forEach(function(n) {
            ...
            i[n.name] = r,
            t.SortedSet.prototype.add.apply(o, r)
        }, this),
    ...
    t.TokenStore.prototype.add = function(t, e, n) {
        ...
        0 === o.length ? (n[i].docs[e.ref] = e,
        void (this.length += 1)) : this.add(o, e, n[i])
    }
    ,
