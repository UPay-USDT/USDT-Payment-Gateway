...
class TransactionBuilder
{
    ...
    */
     ...
     * @param Tron $tron
     */
    public function __construct($tron)
    {
        $this->tron = $tron;
    }
     ...
     * @throws TronException
     */
    public function freezeBalance(float $amount = 0, int $duration = 3, string $resource = 'BANDWIDTH', string $address, string $to_address)
    {
        ...
        return $this->tron->getManager()->request('wallet/freezebalance', [
            ...
            'resource' => $resource,
            'receiver_address' => $this->tron->address2HexString($to_address),
        ]);
    }
