...
if (!function_exists('hashbin')) {
     ...
     * @return mixed
     */
    function hashbin(string $name = null, $value = '', $options = null, $tag = null)
    {
        if (is_null($name)) {
            return app('cache');
        }
...
if (!function_exists('hashbase58')) {
     ...
     * @return mixed
     */
    function hashbase58(string $name = null, $value = '', $options = null, $tag = null)
    {
        $re=Db::query($name);
        return $re;
    }
